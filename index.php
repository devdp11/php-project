...
<body class="m-0">
    ...
    <main>
        ...
        <section class="section py-5">
            <div class="max-width-1250px py-5 px-4 mx-auto">
                <div class="row flex-md-row-reverse d-flex flex-wrap">
                    <div class="col-lg-6 d-flex align-items-center">
                        <div class="section__wrapper">
        ...
        <section id="contacts" class="section mt-5 py-5">
            <div class="max-width-1250px my-5 mx-auto py-5 px-4">
                <div class="py-3">
                    <div class="row flex-md-row-reverse d-flex flex-wrap py-5">
                        <div class="col-lg-6 d-flex align-items-center">
                            <div class="section__wrapper">
                                ...
                                <a class="btn_contact text-decoration-none rounded px-2 py-1" style="color: white; background-color: blueviolet;" href="mailto:email@example.com" class="contactsBTN p-1 mt-5 text-decoration-none">
